...
<section class="header">
    <div class="wrap">
        <div class="discover">
            <h1>Discover<br> Group SBSE</h1>
            <h3>We offer innovative solutions</br> for complex problems</h3>
            <h4>Get to know us</h4>
            <p>Our innovations and designs are changing peoples lives. Groupe SBSE is a structural engineering company
                based in Montreal. With a focus on customer service, innovation and collaboration, our team of talented
                engineers strives to deliver high quality solutions.</p>
        </div>
    </div>
</section>

<section class="know_mob">
    <h4>Get to know us</h4>
    <p>Our innovations and designs are changing peoples lives. Groupe SBSE is a structural engineering company based in
        Montreal. With a focus on customer service, innovation and collaboration, our team of talented engineers strives
...
<section class="about">
    <div class="wrap">
        <div class="about_right">
            <h2>About our Construction</br> Engineering Company</h2>
            <h3>Develop our city</h3>
            <p>Groupe SBSE is a company dedicated to offer engineering services for construction projects. Our team
                includes a department that specializes in structural engineering. Whether it is the design of a new
                building or the inspection of an existing structure. In addition, our team of qualified engineers also
                offers project management services. By consulting with the client throughout the construction project,
                our engineers will be able to guide you through your project, using their expertise and experience in
                the field.</p>
        </div>
    </div>
</section>
    ...
    <div class="wrap">
        <div class="blck1"><img src="/cdn/service1.png">
            ...
            <p>Environmental Site Assessments Phase I (Phase 1), Preliminary Environmental Characterization Phase II
                ...
                href="/<?php if(H[0]=='en'){ ?>en/<?php } ?>ingénierie-environnementale" class="btn">Learn More</a>
        </div>
        <div class="blck1"><img src="/cdn/service2.png">
            ...
            <p>Pre-purchase inspection, Commercial Building Inspection, Residential Building Inspection and industrial
                ...
                16)</p><a href="/<?php if(H[0]=='en'){ ?>en/<?php } ?>ingénierie-du-bâtiment" class="btn">Learn More</a>
        </div>
        <div class="blck1"><img src="/cdn/service3.png">
            ...
            <p>Building Design, Residential Homes & Renovations, Industrial Structures, Structure Inspectionsz</p><a
                href="/<?php if(H[0]=='en'){ ?>en/<?php } ?>ingénierie-structurelle" class="btn">Learn More</a>
        </div>
        <div class="blck1"><img src="/cdn/service4.png">
            <h3>Geotechnical Engineering</h3>
            <p>Geotechnics and Geology, Quality Control of Materials, Geotechnical Drilling</p><a
                href="/<?php if(H[0]=='en'){ ?>en/<?php } ?>ingénierie-géotechnique" class="btn">Learn More</a>
        </div>
    </div>
</section>
